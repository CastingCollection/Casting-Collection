export default function UndoToast({ pending, onUndo, onDismiss }) {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[200] flex items-center gap-3 bg-charcoal text-white px-4 py-3 rounded-xl shadow-2xl border border-gold/30">
